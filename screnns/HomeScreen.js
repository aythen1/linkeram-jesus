    ...
    <ScrollView>
      <View style={styles.contenedor}>
        ...
        <View style={styles.contenedorseccion3}>
          <Text style={styles.tituloh1}>
            ¡Crea, Organiza, Comparte y Monetiza!
          </Text>
          <Text style={styles.parrafo}>
            Todo accesible en un solo lugar. Creemos en el poder de la conexión
            y en las infinitas posibilidades del mundo digital.
          </Text>

          <View style={styles.contenedorprintxt}>
            <View style={styles.contenedortxt}>
              <Text style={styles.txttitulo}>
                Personaliza tu Presencia Digital
              </Text>
              <Text style={styles.txtparrafo}>
                Personaliza tu perfil para reflejar tu identidad y tus intereses
                de manera única y atractiva.
              </Text>
            </View>
            <View style={styles.contenedortxt}>
              <Text style={styles.txttitulo}>
                Crea y Organiza tu Contenido Digital
              </Text>
              <Text style={styles.txtparrafo}>
                Comparte tus intereses o tu trabajo y conecta con personas que
                aprecian tu perspectiva única. Mantén tu contenido organizado y
                fácil de encontrar para ti y tus seguidores. .
              </Text>
            </View>
            <View style={styles.contenedortxt}>
              <Text style={styles.txttitulo}>¡Monetiza sin límites!</Text>
              <Text style={styles.txtparrafo}>
                Convierte tu pasión en ganancias con las herramientas de
                monetización.
              </Text>
            </View>
          </View>
        ...
        <View style={styles.contenedorseccion4}>
          ...
          <Text style={styles.parrafo}>
            Todos tus mensajes de las principales plataformas de mensajería en
            un solo lugar.
          </Text>

          <View style={styles.contenedorsocial}>
            <Image source={social1} style={styles.imgsocial} />
            <Image source={social2} style={styles.imgsocial} />
            <Image source={social3} style={styles.imgsocial} />
            <Image source={social4} style={styles.imgsocial} />
            <Image source={social5} style={styles.imgsocial} />
            <Image source={social6} style={styles.imgsocial} />
            <Image source={social7} style={styles.imgsocial} />
          </View>
        </View>
        ...
        <View style={styles.contenedorseccion5}>
          <View style={styles.contenedorprintxt2}>
            ...
            <Image source={candado} style={styles.imgsocialcand} />
            <View style={styles.contenedortxt2}>
          ...
          <Text style={styles.parrafo}>
            Entiende mejor a tu audiencia, optimiza tus estrategias y ve crecer
            tus ingresos.
          </Text>

          <View style={styles.contenedorprintxt2}>
            <View style={styles.contenedortxt2}>
              <Image source={grafico} style={styles.imgsocialcand2} />
              <View style={styles.contencoluna}>
                <Text style={styles.txtfont}>W</Text>
                <Text style={styles.txtfont}>T</Text>
                <Text style={styles.txtfont}>W</Text>
                <Text style={styles.txtfont}>T</Text>
                <Text style={styles.txtfont}>F</Text>
                <Text style={styles.txtfont}>S</Text>
              </View>
              <View style={styles.contencoluna2}>
                <Text style={styles.txtfont2}>40K</Text>
                <Text style={styles.txtfont2}>30K</Text>
                <Text style={styles.txtfont2}>20K</Text>
                <Text style={styles.txtfont2}>10K</Text>
              </View>
            </View>

            <View style={styles.contenedortxt4}>
              <Text style={styles.txttitulo}>
                Comparte tu actividad digital con el Mundo
              </Text>
              <Text style={styles.txtparrafo}>
                Difunde y promociona tu contenido de manera efectiva, alcanzando
                a una audiencia global. Haz un seguimiento del engagement a lo
                largo del tiempo, monitorea tus ingresos y descubre qué está
                convirtiendo a tu audiencia.
              </Text>
            </View>
          </View>
        </View>
