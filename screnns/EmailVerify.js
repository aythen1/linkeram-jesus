    ...
    <ScrollView>
      <View style={styles.contenedor}>
        ...
        <View style={styles.singupseccion1}>
          ...
          <Text style={styles.text}>Revisa tu casilla de correo</Text>
          <Text style={styles.txtnormalcent}>
            {" "}
            Enviamos un email a la dirección ingresada para reestablecer tu
            contraseña.{" "}
          </Text>

          <View>
            <TouchableOpacity style={styles.btnsesion4}>
              <Text style={styles.txtbtn33}>Reenviar</Text>
            </TouchableOpacity>
            <View style={styles.contenopc2}></View>

            <View>
              <TouchableOpacity style={styles.btnsesion3}>
                <Text style={styles.txtbtn3}>Iniciar sesión</Text>
              </TouchableOpacity>
              <View style={styles.contenopc2}></View>
            </View>
          </View>
