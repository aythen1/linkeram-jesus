    ...
    <ScrollView>
      <View style={styles.contenedor}>
        ...
        <View style={styles.singupseccion1}>
          ...
          <Text style={styles.text}>¿Olvidaste tú contraseña?</Text>
          <Text style={styles.txtnormalcent}>
            {" "}
            Ingresa tu email registrado a tu cuenta de Linkeram para resetear tu
            contraseña{" "}
          </Text>

          <TextInput style={styles.btnsesion3} placeholder="email" />
          ...
          <View>
            <View style={styles.capchadiv}>
              <View style={styles.capchadivcontent}>
                ...
                <Text style={styles.txtnormalck}>
                  <CheckBox value={isChecked} onValueChange={handleCheck} /> I'm
                  not a robot
                </Text>
            ...
            <View style={styles.contenopc2}>
              <Text style={styles.txtnormal}>
                ...
                <Text style={styles.txtnormalbold}>Iniciar Sesión</Text>
              </Text>
            </View>
          </View>
        </View>
